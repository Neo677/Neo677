<p align="center">
  <picture>
    ...
    <img src="assets/header-light.svg" alt="Thomas — Software Engineer, 42 Nice" width="100%" />
  </picture>
</p>

<p align="center"><em>
  &ldquo;I must not fear. Fear is the mind-killer.<br/>
  Fear is the little-death that brings total obliteration.<br/>
  I will face my fear and permit it to pass over me and through me.&rdquo;
</em></p>
<p align="center"><sub>— Frank Herbert, <em>Dune</em></sub></p>

## About

I'm a software-engineering student at **42 Nice**, working across the full depth of
the stack — from memory-tight systems code in **C and C++**, to **machine-learning**
projects in Python, to **full-stack web** applications. I care about correctness,
clean abstractions, and tooling that gets out of the way.
...
- **multilayer-perceptron** · *Python* — Neural network with backpropagation, built from scratch.
- **Total-perspective-vortex** · *Python* — EEG brain–computer interface: PCA + classification pipeline.
- **Leaffliction** · *Python* — Computer-vision pipeline for leaf-disease classification.
- **Learn2Slither** · *Python* — Reinforcement-learning agent that learns to play Snake.
- **ft_linear_regression** · *Python* — Price prediction via gradient-descent linear regression.
- **Gomoku** · *Python* — Gomoku engine with a min–max AI opponent.

**Systems & infrastructure**

- [**DooM-Nukem_3D**](https://github.com/Neo677/DooM-Nukem_3D) · *C* — Raycasting 3D engine in the Doom / Wolfenstein lineage.
- **Inception-of-Things** · *Kubernetes · Shell* — K3s / K3d clusters with a GitOps workflow.

**Web & applications**

- **Red-Tetris** · *JavaScript* — Online multiplayer Tetris (React, Redux, Node, sockets).
- **Music-Room** · *TypeScript* — Collaborative, multi-platform music application.

**Blockchain**

- **Tokenizer** · *Solidity* — ERC-20 token and smart contracts on Ethereum.
...
<p align="center">
  <a href="mailto:grandmasterchenn@gmail.com">Email</a>
  &nbsp;·&nbsp;
  <a href="https://github.com/Neo677">GitHub</a>
</p>
